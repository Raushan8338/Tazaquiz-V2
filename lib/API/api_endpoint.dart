...
class BaseUrl {
  ...
  static String get_id_wise_quiz = "get_id_wise_quiz_v2.php";
  ...
  static String Quiz_performanceApi = "performanceApi_v2.php";
  ...
  static String fetch_paid_quizes_api = "paid_quizes_api_v2.php";
