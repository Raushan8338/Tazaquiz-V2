...
class Authrepository {
  ...
  Future<Response> fetchHomePageData(Map<String, String?> data_user) async {
      FormData formData = FormData.fromMap(data_user);
  ...
  Future<Response> get_paid_quizes_api(Map<String, dynamic> data) async {
    FormData formData = FormData.fromMap(data);
  ...
  Future<Response> fetchCourseSearchResults(Map<String, dynamic> data) async {
    FormData formData = FormData.fromMap(data);
