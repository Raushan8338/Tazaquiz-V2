...
class _TestSeriesDetailPageState extends State<TestSeriesDetailPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          _buildAppBar(),
          SliverToBoxAdapter(child: Column(children: [_buildSeriesInfo(), _buildProgressCard(), _buildTabBar()])),
          SliverFillRemaining(
            child: TabBarView(controller: _tabController, children: [_buildQuizListTab(), _buildStudyMaterialsTab()]),
          ),
        ],
      ),
    );
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(color: AppColors.lightGold, borderRadius: BorderRadius.circular(6)),
                        child: Row(
                          children: [
  ...
  Widget _buildProgressStat(String label, String value) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        AppRichText.setTextPoppinsStyle(context, value, 16, AppColors.white, FontWeight.w900, 1, TextAlign.left, 0.0),
        SizedBox(height: 2),
        AppRichText.setTextPoppinsStyle(
          context,
          label,
    ...
    return Opacity(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isLocked ? Border.all(color: AppColors.greyS300, width: 2) : null,
          boxShadow:
              isLocked
                  ? []
                  : [BoxShadow(color: AppColors.black.withOpacity(0.08), blurRadius: 15, offset: Offset(0, 5))],
        ),
        child: Stack(
          children: [
            Column(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        runSpacing: 6,
                        children:
                            (quiz['topics'] as List<String>).map((topic) {
                              return Container(
                                padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                                decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          Container(
            padding: EdgeInsets.all(16),
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [typeColor.withOpacity(0.1), typeColor.withOpacity(0.05)]),
              borderRadius: BorderRadius.vertical(top: Radius.circular(16)),
            ),
            child: Row(
              children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 6,
                  children:
                      (material['topics'] as List<String>).map((topic) {
                        return Container(
                          padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                          decoration: BoxDecoration(
                            color: AppColors.greyS1,
