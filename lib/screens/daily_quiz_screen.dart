...
class _DailyQuizScreenState extends State<DailyQuizScreen>
  ...
  void _submitAnswer() async {
    ...
    _userAnswers.add({
      ...
      'selected':    String.fromCharCode(65 + _selectedOption!), // A/B/C/D
    });
            ...
            child: Row(
              children: [
                ...
                AppRichText.setTextPoppinsStyle(
                  context, 'Aaj Ka Daily Quiz', 13, AppColors.white, FontWeight.w700, 1, TextAlign.left, 0.0),
              ],
            ),
          ),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 20),
                  AppRichText.setTextPoppinsStyle(
                    context, 'Aaj ka Quiz De Diya! 🎉', 22, AppColors.darkNavy, FontWeight.w900, 1, TextAlign.center, 0.0),
                  const SizedBox(height: 6),
                  AppRichText.setTextPoppinsStyle(
                    context, 'Kal phir aana naya quiz leke!', 13, AppColors.greyS600, FontWeight.normal, 1, TextAlign.center, 0.0),
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            AppRichText.setTextPoppinsStyle(
                              context, 'Performance', 13, AppColors.darkNavy, FontWeight.w700, 1, TextAlign.left, 0.0),
                            AppRichText.setTextPoppinsStyle(
                              context, '$pct%', 13, AppColors.tealGreen, FontWeight.w900, 1, TextAlign.left, 0.0),
                          ],
                        ),
                        const SizedBox(height: 10),
                        ClipRRect(
                    ...
                    child: Ink(
                      ...
                      child: Container(
                        ...
                        child: AppRichText.setTextPoppinsStyle(
                          context, 'Back to Home', 14, AppColors.white, FontWeight.w700, 1, TextAlign.center, 0.0),
                      ),
                    ),
                  ),
                ],
  ...
  // ═══════════════════════════════════════════
  // HEADER — LiveTestScreen jaisa exact
  // ═══════════════════════════════════════════
  Widget _buildHeader() {
    return Container(
      padding: EdgeInsets.only(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    AppRichText.setTextPoppinsStyle(
                      context, 'Aaj Ka Daily Quiz', 13, AppColors.white, FontWeight.w700, 3, TextAlign.left, 0.0),
                    ...
                    Row(
                      children: [
                        AppRichText.setTextPoppinsStyle(
                          ...
                          11, AppColors.lightGold, FontWeight.w600, 1, TextAlign.left, 0.0),
                        ...
                        Container(
                          ...
                          child: AppRichText.setTextPoppinsStyle(
                            context, 'DAILY', 10, AppColors.white, FontWeight.w900, 1, TextAlign.left, 0.0),
                        ),
                      ],
                    ),
                  ],
              ...
              // Score badge — LiveTestScreen jaisa
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    AppRichText.setTextPoppinsStyle(
                      context, '$_score', 14, AppColors.darkNavy, FontWeight.w900, 2, TextAlign.left, 0.0),
                  ],
                ),
              ),
            ],
  ...
  // ═══════════════════════════════════════════
  // PROGRESS — exact same as LiveTestScreen
  // ═══════════════════════════════════════════
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              AppRichText.setTextPoppinsStyle(
                context, 'Question ${_currentQuestion + 1}/$totalQuestions',
                14, AppColors.darkNavy, FontWeight.w600, 2, TextAlign.left, 0.0),
              ScaleTransition(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 6),
                      AppRichText.setTextPoppinsStyle(
                        context, '$_timeLeft', 14, AppColors.white, FontWeight.w900, 2, TextAlign.left, 0.0),
                      AppRichText.setTextPoppinsStyle(
                        context, 's', 14, AppColors.white, FontWeight.w600, 2, TextAlign.left, 0.0),
                    ],
                  ),
                ),
              ),
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    AppRichText.setTextPoppinsStyle(
                      context, 'Progress', 11, AppColors.greyS600, FontWeight.normal, 2, TextAlign.left, 0.0),
                    const SizedBox(height: 6),
                    ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: LinearProgressIndicator(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    AppRichText.setTextPoppinsStyle(
                      context, 'Time', 11, AppColors.greyS600, FontWeight.normal, 2, TextAlign.left, 0.0),
                    const SizedBox(height: 6),
                    ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: LinearProgressIndicator(
                        ...
                        valueColor: AlwaysStoppedAnimation(
                          _timeLeft <= 5 ? AppColors.red
                              : _timeLeft <= 10 ? AppColors.orange
                              : AppColors.tealGreen),
                        minHeight: 8,
                      ),
                    ),
  ...
  // ═══════════════════════════════════════════
  // QUESTION CARD — exact same as LiveTestScreen
  // ═══════════════════════════════════════════
          ...
          Row(
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                    AppRichText.setTextPoppinsStyle(
                      context, _currentQuestionData['category'] ?? '',
                      12, AppColors.tealGreen, FontWeight.w700, 2, TextAlign.left, 0.0),
                  ],
                ),
              ),
              const Spacer(),
              Container(
                ...
                child: AppRichText.setTextPoppinsStyle(
                  context, 'Daily Quiz', 11, AppColors.red, FontWeight.w700, 2, TextAlign.left, 0.0),
              ),
            ],
          ),
          const SizedBox(height: 10),
          AppRichText.setTextPoppinsStyle(
            context, _currentQuestionData['question'] ?? '',
            15, AppColors.darkNavy, FontWeight.w700, 2, TextAlign.left, 0.0),
        ],
      ),
    );
  }
  ...
  // ═══════════════════════════════════════════
  // OPTIONS — exact same as LiveTestScreen
  // ═══════════════════════════════════════════
            ...
            Container(
              ...
              child: Center(
                child: AppRichText.setTextPoppinsStyle(
                  ...
                  FontWeight.w900, 2, TextAlign.left, 0.0),
              ),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: AppRichText.setTextPoppinsStyle(
                context, text, 14, AppColors.darkNavy, FontWeight.w600, 2, TextAlign.left, 0.0),
            ),
          ],
        ),
      ),
  ...
  // ═══════════════════════════════════════════
  // SUBMIT BUTTON — exact same as LiveTestScreen
  // ═══════════════════════════════════════════
      ...
      child: ElevatedButton(
        ...
        child: Ink(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(16),
            boxShadow: canSubmit
                ? [BoxShadow(color: AppColors.tealGreen.withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 10))]
                : [],
          ),
          child: Container(
            width: double.infinity,
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 12),
                AppRichText.setTextPoppinsStyle(
                  context, 'Submit Answer', 14,
                  canSubmit ? AppColors.white : AppColors.greyS500,
                  FontWeight.w700, 2, TextAlign.left, 0.0),
              ],
            ),
          ),
        ),
  ...
  // ═══════════════════════════════════════════
  // RESULT DIALOG — LiveTestScreen jaisa exact
  // ═══════════════════════════════════════════
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [AppColors.tealGreen, AppColors.darkNavy]),
                  shape: BoxShape.circle,
                  boxShadow: [BoxShadow(color: AppColors.tealGreen.withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 10))],
                ),
                child: Icon(Icons.emoji_events, color: AppColors.lightGold, size: 40),
              ),
              const SizedBox(height: 24),
              AppRichText.setTextPoppinsStyle(
                context, 'Quiz Complete!', 18, AppColors.darkNavy, FontWeight.w900, 2, TextAlign.left, 0.0),
              const SizedBox(height: 8),
              AppRichText.setTextPoppinsStyle(
                context, message, 12, AppColors.greyS600, FontWeight.normal, 2, TextAlign.left, 0.0),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [
                    ...
                    AppColors.lightGoldS2.withOpacity(0.2),
                  ]),
                  borderRadius: BorderRadius.circular(16),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          AppRichText.setTextPoppinsStyle(
                            context, '$totalParticipants students ne aaj diya',
                            12, AppColors.darkNavy, FontWeight.w700, 2, TextAlign.left, 0.0),
                          AppRichText.setTextPoppinsStyle(
                            context, 'Keep practicing to improve!',
                            11, AppColors.greyS700, FontWeight.normal, 2, TextAlign.left, 0.0),
                        ],
                      ),
                    ),
                    AppRichText.setTextPoppinsStyle(
                      context, '$percentage%', 16, AppColors.tealGreen, FontWeight.w900, 1, TextAlign.left, 0.0),
                  ],
                ),
              ),
              const SizedBox(height: 24),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      child: AppRichText.setTextPoppinsStyle(
                        context, 'Review', 13, AppColors.darkNavy, FontWeight.w700, 2, TextAlign.left, 0.0),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: Ink(
                        ...
                        child: Container(
                          ...
                          alignment: Alignment.center,
                          child: AppRichText.setTextPoppinsStyle(
                            context, 'Done', 13, AppColors.white, FontWeight.w700, 2, TextAlign.left, 0.0),
                        ),
                      ),
                    ),
                  ),
  ...
  // ═══════════════════════════════════════════
  // EXIT DIALOG — exact same as LiveTestScreen
  // ═══════════════════════════════════════════
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              AppRichText.setTextPoppinsStyle(
                context, 'Quiz Chhod Dein?', 16, AppColors.darkNavy, FontWeight.w700, 2, TextAlign.left, 0.0),
              const SizedBox(height: 12),
              AppRichText.setTextPoppinsStyle(
                context, 'Agar ab chode toh aaj ka quiz miss ho jayega!',
                11, AppColors.greyS600, FontWeight.normal, 2, TextAlign.center, 0.0),
              const SizedBox(height: 24),
              Row(
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      child: AppRichText.setTextPoppinsStyle(
                        context, 'Cancel', 13, AppColors.greyS700, FontWeight.w600, 2, TextAlign.left, 0.0),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: AppRichText.setTextPoppinsStyle(
                        context, 'Exit', 13, AppColors.white, FontWeight.w700, 2, TextAlign.left, 0.0),
                    ),
                  ),
                ],
              ),
